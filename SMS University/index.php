<?php
// Add this at the very top of your existing index.php file
require_once 'auth_config.php';
requireLogin(); // This will redirect to login.php if not authenticated
...
// Fetch data based on active tab and search term
...
<body class="bg-gray-100 min-h-screen">
            ...
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center space-x-4">
                    <div class="flex items-center space-x-2">
                        ...
                        <h1 class="text-xl font-bold text-gray-900">University Management System</h1>
                    </div>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="border-l border-gray-300 pl-4">
                            <a href="logout.php" class="flex items-center space-x-1 text-sm text-gray-600 hover:text-gray-800">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div class="space-y-4">
                            ...
                            <div class="text-center py-8 text-gray-500">
                                <?php if (!empty($searchTerm)): ?>
                                No faculty members found matching "<?php echo htmlspecialchars($searchTerm); ?>"
                                <?php else: ?>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mt-6">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <div class="flex space-x-2">
                                <button onclick="generateReport('all')" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
                                    <i class="fas fa-file-pdf mr-2"></i>Export All
                                </button>
                                <button onclick="generateReport('students')" class="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700">
                                    <i class="fas fa-file-pdf mr-2"></i>Export Students
                                </button>
                                <button onclick="generateReport('courses')" class="px-4 py-2 bg-purple-600 text-white rounded hover:bg-purple-700">
                                    <i class="fas fa-file-pdf mr-2"></i>Export Courses
                                </button>
                                <button onclick="generateReport('faculty')" class="px-4 py-2 bg-orange-600 text-white rounded hover:bg-orange-700">
                                    <i class="fas fa-file-pdf mr-2"></i>Export Faculty
                                </button>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <form method="POST" action="index.php">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select name="current_semester" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select name="academic_year" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
    ...
    <script>
        ...
        function generateReport(type) {
            ...
            switch(type) {
                case 'all':
                    message = 'Generating PDF report for all data...';
                    break;
                case 'students':
                    message = 'Generating PDF report for student data...';
                    break;
                case 'courses':
                    message = 'Generating PDF report for course data...';
                    break;
                case 'faculty':
                    message = 'Generating PDF report for faculty data...';
                    break;
            }
